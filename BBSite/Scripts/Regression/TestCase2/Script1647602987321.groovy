...
WebUI.selectOptionByValue(findTestObject('Payment and Transfer/Add Tax Payment/ExciseTaxType_select'), Excisetaxtype, 
    false)
...
KeywordUtil.markPassed('System Navigated to Confirmation Page')
...
WebUI.click(findTestObject('Payment and Transfer/Add Account Transfer/Account Transfer Confirmation/Logoutbutton_footer'))
