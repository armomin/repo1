...
Amount = WebUI.getAttribute(findTestObject('Payment and Transfer/Add Tax Payment/TaxAmount_input'), 'value')

CustomKeywords.'bbSiteDemo.MatchSubstring.matchSubStringAndVerify'(Amount, '$')
